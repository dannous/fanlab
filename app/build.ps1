...
$PureSources = @(
    ...
    'LedDrive.java',
    # CAIC's arm-and-confirm window. Pure for the same reason: "an unconfirmed change
    # reverts itself, and is never persisted" is a safety property, and the host test can
    # walk the whole countdown on a fake clock in microseconds.
    'CaicArm.java',
