...
The README covers using it. This is the engineering: what was measured, why the curve is the
shape it is, and what was built and rejected along the way.

The deeper derivations live alongside this file — [curve.md](curve.md) for how the curve was
derived, [safety.md](safety.md) for the full safety argument, [findings.md](findings.md) for
what taking the firmware apart established.

## Driving it from a PC

Everything above is also settable over adb, which is how it is developed and how the curve
is deployed. The full reference is in [deploy.md](deploy.md). The two commands
worth knowing:
...
[curve.md](curve.md#the-bright-preset-family) rather than here, because they are
...
[curve.md](curve.md#the-redraw-that-was-tried-against-the-measured-plant-and-rejected).
...
[curve.md](curve.md#what-it-costs-stated-rather-than-buried).
...
see [curve.md](curve.md#stability-of-the-bright-family).
...
Summarised; the detail is in [findings.md](findings.md).
